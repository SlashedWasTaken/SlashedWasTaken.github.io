...
searchInput.setAttribute('placeholder', 'Start by typing any Brave Little Abacus song!')
showIntro()
//initLocalStorage()
sideStatistics()
...
function newMysterySong() {
    ...
    mysteryNumber = Math.floor(Math.random() * 40) + 1;
...
function formatScoreText(resultsArray) {
    let formattedScoreText = "BRAVE WORDLE ABACUS #" + longvideoleDay + ": " + (Number(guessCount) - 1) + "/" + maxGuesses + "\n"  //+ "\n"
